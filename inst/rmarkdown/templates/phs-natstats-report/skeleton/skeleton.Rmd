...
<!-- YOU CAN DO THIS BY RUNNING THE CHUNK DIRECTLY BELOW CALLED run_this_chunk OR 
<!-- BY GOING TO Session -> Set Working Directory -> To Source File Location -->
...
```{r run_this_chunk, include = FALSE, eval = FALSE}
...
TableData <- data.frame(
  ...
  Table.Head = c("Table body","Table body", "Table body",
                 "Table body (with Total Row option in Table Style options ticked)"),
  Table.Head = c("Table body right aligned (for numbers) 22","22","22","221"),
...
headings <- list("Table Head", "Table Head", "Table Head", "Table Head", "Table Head")
