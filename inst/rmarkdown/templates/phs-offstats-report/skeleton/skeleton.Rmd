...
<!-- PLEASE NOTE THAT YOU FIRST NEED TO UPDATE YOUR WORKING DIRECTORY BY GOING TO Session -> Set Working Directory -> To Source File Location. THEN EDIT THIS FILE FOR YOUR REPORT CONTENTS. ONCE YOU ARE READY TO CREATE THE REPORT, NAVIGATE TO YOUR WORKING DIRECTORY AND OPEN 'create_report.R'. CHANGE THE PARAMETERS AS REQUIRED (e.g. rmd_filename = "template name you gave.Rmd") AND RUN ALL THE CODES TO COMPILE THE WHOLE REPORT WITH COVER PAGE AND TABLE OF CONTENTS. -->
