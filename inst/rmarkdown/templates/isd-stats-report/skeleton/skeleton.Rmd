...
FigureOne <- ggplot(data = FigureOneData, aes(x = HBR, y = UptakeRate, fill = HBR)) +
  geom_bar(width = 0.4, position = "dodge", stat = "identity",  show.legend = F) + 
  scale_y_continuous(breaks = c(50, 55, 60, 65, 70, 75, 80, 85, 90), 
                     limits = c(50, 91), 
                     oob = squish, expand = expand_scale(mult = 0)) + 
  geom_hline(yintercept = 70, size = 1, color = "#092869") +
  geom_hline(yintercept = 80, size = 1, color = "#092869", linetype = "dashed") +
  coord_flip() +
  theme(panel.background = element_blank(),
    panel.grid.major.x = element_line(size = .4, color = "#C0C0C0"), 
    panel.grid.major.y = element_blank(),
    plot.margin = margin(t = 18), 
    axis.ticks.x = element_blank(), 
    axis.ticks.y = element_blank(), 
    axis.title.x = element_text(size = 7, face = "bold", margin = margin(t = 10)),
    axis.title.y = element_text(size = 7, face = "bold", margin = margin(r = 10)),
    axis.text = element_text(size = 7, colour = 'black'),
    axis.line.x = element_line(size = .18, colour = 'black'),
    axis.line.y = element_line(size = .18, colour = 'black')) +
  ...
  scale_fill_manual(values = c("#00a2e5", "#00a2e5", "#00a2e5", "#00a2e5", "#00a2e5", 
                               "#00a2e5", "#00a2e5", "#00a2e5", "#00a2e5", "#00a2e5",
                               "#00a2e5", "#092869", "#00a2e5", "#00a2e5", "#00a2e5")) +
  xlab("NHS Board of Residence") + ylab("Uptake rate (%)")

ggsave("Figure1_ggplot.png", plot = FigureOne, width = 17, height = 9.5, units = "cm", 
       device = "png", dpi = 600)
...
FigureTwo <- ggplot(data = FigureTwoData, aes(x = RollingYear, y = DetectionRate)) +
  ...
  theme(panel.background = element_blank(),
    ...
    panel.grid.major.y = element_line(size = .2, color = "#C0C0C0"), 
...
ggsave("Figure2_ggplot.png", plot = FigureTwo, width = 15, height = 9.25, units = "cm", 
       device = "png", dpi = 600)
```
...
Further information and data for this publication are available from  the [ISD website](http://www.isdscotland.org/).  
...
The next release of this publication will be D Month YYYY.  

<br>

<Div custom-style = "Heading 2_nopgbrk">Open data</div>
...
Please [provide feedback](mailto:YOUR-GENERIC-MAILBOX@nhs.net?subject=Feedback) on this publication to help us improve our services.
